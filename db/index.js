...
(function migrar() {
  ...
  if (!colsClientes.includes('contacto_nombre')) raw.exec("ALTER TABLE clientes ADD COLUMN contacto_nombre TEXT NOT NULL DEFAULT ''");
  ...
  if (!colsClientes.includes('grupo_id')) raw.exec('ALTER TABLE clientes ADD COLUMN grupo_id INTEGER REFERENCES clientes(id) ON DELETE SET NULL');
